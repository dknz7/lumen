// Image-proxy dimension presets. Matches Plex Web's request shape per surface
// so we share its CDN cache and avoid 404s on cold-miss permutations.

export const imageDims = {
  poster:    { w: 240, h: 360 },  // Card.tsx posters, Watchlist cards
  landscape: { w: 480, h: 270 },  // Card.tsx when cardLayout is "landscape"
